...
const IconButton: Component<IconButtonProps> = ({ className, icon }) => {
  return (
    <button class={clsx(className, "icon-button")}>
      <Switch>
        <Match when={icon === "hamburger"}>
          <svg
            class="icon-button__menu-icon"
        ...
        <Match when={icon === "facebook"}>
          <svg
            class="icon-button__nav-icon"
            xmlns="http://www.w3.org/2000/svg"
            width="20"
            height="20"
            viewBox="0 0 20 20"
